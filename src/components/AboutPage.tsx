  ...
  return (
    <article aria-labelledby="about-title">
      ...
      <header className="text-center mb-10">
        <h1 id="about-title" className="text-2xl md:text-3xl font-bold text-slate-800 mb-3 tracking-tight">
      ...
      {/* Mission */}
      <section aria-labelledby="mission-heading" className="bg-white rounded-xl p-6 md:p-8 shadow-sm ring-1 ring-slate-100 mb-8">
        <h2 id="mission-heading" className="text-base font-semibold text-slate-800 mb-4 flex items-center gap-2.5">
          <Heart className="text-amber-500" size={18} aria-hidden="true" />
          Our Mission
        </h2>
      ...
      <section aria-labelledby="what-we-do-heading">
        <h2 id="what-we-do-heading" className="sr-only">What We Do</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          {[
            {
              icon: <BookOpen className="text-amber-500" size={18} aria-hidden="true" />,
            ...
            {
              icon: <Users className="text-amber-500" size={18} aria-hidden="true" />,
            ...
            {
              icon: <Globe className="text-amber-500" size={18} aria-hidden="true" />,
            ...
            {
              icon: <Heart className="text-amber-500" size={18} aria-hidden="true" />,
            ...
            <article key={i} className="bg-white rounded-xl p-5 shadow-sm ring-1 ring-slate-100">
              <div className="w-9 h-9 rounded-lg bg-amber-50 flex items-center justify-center mb-3 ring-1 ring-amber-200/50" aria-hidden="true">
                {item.icon}
              </div>
      ...
      {/* Contact Info */}
      <section aria-labelledby="contact-info-heading" className="bg-slate-800 rounded-xl p-6 md:p-8">
        <h2 id="contact-info-heading" className="text-base font-semibold text-white mb-5">Get In Touch</h2>
        <address className="not-italic grid grid-cols-1 md:grid-cols-2 gap-5 text-[13px]">
          <div>
