    ...
    <footer className="bg-slate-900 mt-16 transition-colors duration-300" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="border-t border-white/[0.06] mt-8 pt-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-[11px] text-slate-500">© {currentYear} SFA Daily Articles. All rights reserved.</p>
          <p className="text-[11px] text-slate-500">Designed for School-for-All Welfare Organization · Turbat, Balochistan</p>
        </div>
      </div>
    </footer>
  );
